data_root = '/work/data/kitti/dataset'
ann_file = '/work/data/kitti/dataset/labels'
stereo_depth_root = '/work/data/kitti/depth'
camera_used = ['left']
...
train_pipeline = [
    ...
    dict(type='CollectData', keys=['img_inputs', 'gt_occ'],
            meta_keys=['pc_range', 'occ_size', 'raw_img', 'stereo_depth', 'focal_length', 'baseline', 'img_shape', 'gt_depths','gt_depths2','img_filename','k','pose','k1','flow']),
]
...
test_pipeline = [
    ...
    dict(type='CollectData', keys=['img_inputs', 'gt_occ'],
            meta_keys=['pc_range', 'occ_size', 'sequence', 'frame_id', 'raw_img', 'stereo_depth', 'focal_length', 'baseline', 'img_shape', 'gt_depths','gt_depths2','img_filename','k','pose','k1','flow'])
]
